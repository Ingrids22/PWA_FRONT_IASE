...
import { useSettings, playCompletionSound } from "./useSettings";
...
export default function Dashboard() {
  ...
  async function handleStatusChange(task: Task, newStatus: Status) {
    ...
    if (newStatus === "Completada") playCompletionSound(settings.sound); // ← NUEVO
  ...
  return (
    <div className="wrap">
      ...
      <SettingsPanel settings={settings} onUpdate={updateSettings} /> {/* ← NUEVO */}
    </div>
  );
}